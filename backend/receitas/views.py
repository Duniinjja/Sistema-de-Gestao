...
from .serializers import CategoriaReceitaSerializer, ReceitaSerializer
...
class CategoriaReceitaViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if user.tipo_usuario == 'ADMIN_CHEFE':
            return CategoriaReceita.objects.all()
        return CategoriaReceita.objects.filter(empresa=user.empresa)
